...
class Core {
	...
	drawText( text ){
		...
		this.intervalID = setInterval( () => {
			let obj = wrap_text( { text: text, font: '16px monospace', maxWidth: 380, lineHeight: 2 } );
	...
	choose( text, node_id, choices ) {
		...
		actual_choices.forEach( ( choice ) => {
			...
			let a = '<div name="' + ctr + '" class="noselect">' + ctr + '.) ' + choice.text + '</div>';
			buttons.push( '<button onclick="button_event(' + ctr + ')">' + a + '</button><br/>' );
			ctr++;
		} );
		_console_log( '---------' );
...
class Scene {
	...
	loadSounds( cb ){
		...
		window.createjs.Sound.on( 'fileload', ( event ) => {
			ctr++;
			let ins = this.sounds[ event.id ] = window.createjs.Sound.play( event.id );
			ins.on( 'complete', () => {
				ins.stop();
				ins.play();
			} );
	...
	load( canvas_id, cb ) {
		if ( canvas_id ) {
			...
			this.loadPicture( 'invisible', 'assets/img/Comic1/invisible.png', on_pic, true );
			this.loadPicture( 'default', 'assets/img/Comic1/default.png', on_pic, true );
			this.loadPicture( 'default-bg', 'assets/img/Comic1/default-bg.png', on_pic );
			this.loadPicture( 'ConscienceBG', 'assets/img/Comic1/conscience-bg.png', on_pic );

			this.loadPicture( 'Conscience_bg1', 'assets/img/Comic1/conscience-bg1.png', on_pic );
			this.loadPicture( 'Conscience_bg2', 'assets/img/Comic1/conscience-bg2.png', on_pic );
			this.loadPicture( 'Conscience_bg3', 'assets/img/Comic1/conscience-bg3.png', on_pic );
			this.loadPicture( 'Conscience_bg4', 'assets/img/Comic1/conscience-bg4.png', on_pic );
			this.loadPicture( 'Conscience_bg5', 'assets/img/Comic1/conscience-bg5.png', on_pic );

			this.loadPicture( 'Conscience_normal', 'assets/img/Comic1/Conscience_normal.png', on_pic, true );
			this.loadPicture( 'Conscience_frowning', 'assets/img/Comic1/Conscience_frowning.png', on_pic, true );
			this.loadPicture( 'Conscience_sad', 'assets/img/Comic1/Conscience_sad.png', on_pic, true );
			this.loadPicture( 'Conscience_smiling', 'assets/img/Comic1/Conscience_smiling.png', on_pic, true );

			this.loadPicture( 'Conscience_entrance', 'assets/img/Comic1/Conscience_entrance.png', on_pic );
			this.loadSprite( 'Conscience_entrance1', 'Conscience_entrance', 200 * 0, 0, 200, 200 );
			this.loadSprite( 'Conscience_entrance2', 'Conscience_entrance', 200 * 1, 0, 200, 200 );
			this.loadSprite( 'Conscience_entrance3', 'Conscience_entrance', 200 * 2, 0, 200, 200 );
			this.loadSprite( 'Conscience_entrance4', 'Conscience_entrance', 200 * 3, 0, 200, 200 );
			this.loadSprite( 'Conscience_entrance5', 'Conscience_entrance', 200 * 4, 0, 200, 200 );
			this.loadSprite( 'Conscience_entrance6', 'Conscience_entrance', 200 * 5, 0, 200, 200 );

			this.loadPicture( 'black-bar', 'assets/img/Comic1/black-bar.png', on_pic, true );
			this.loadPicture( 'black-bar-left', 'assets/img/Comic1/black-bar-left.png', on_pic, true );
			this.loadPicture( 'black-bar-right', 'assets/img/Comic1/black-bar-right.png', on_pic, true );
			this.loadPicture( 'black-screen', 'assets/img/Comic1/black-screen.png', on_pic, true );

			this.loadPicture( 'Ada_actor_idle1', 'assets/img/Comic1/Ada_actor_idle1.png', on_pic );
			this.loadSprite( 'Ada_actor_idle1_1', 'Ada_actor_idle1', 125 * 0, 0, 125, 125 );
			this.loadSprite( 'Ada_actor_idle1_2', 'Ada_actor_idle1', 125 * 1, 0, 125, 125 );
			this.loadSprite( 'Ada_actor_idle1_3', 'Ada_actor_idle1', 125 * 2, 0, 125, 125 );
			this.loadSprite( 'Ada_actor_idle1_4', 'Ada_actor_idle1', 125 * 3, 0, 125, 125 );
			this.loadSprite( 'Ada_actor_idle1_5', 'Ada_actor_idle1', 125 * 4, 0, 125, 125 );

			this.loadPicture( 'Ada_actor_idle2', 'assets/img/Comic1/Ada_actor_idle2.png', on_pic );
			this.loadSprite( 'Ada_actor_idle2_1', 'Ada_actor_idle2', 300 * 0, 0, 300, 300 );
			this.loadSprite( 'Ada_actor_idle2_2', 'Ada_actor_idle2', 300 * 1, 0, 300, 300 );
			this.loadSprite( 'Ada_actor_idle2_3', 'Ada_actor_idle2', 300 * 2, 0, 300, 300 );

			this.loadPicture( 'Ada_actor_idle3', 'assets/img/Comic1/Ada_actor_idle3.png', on_pic );
			this.loadSprite( 'Ada_actor_idle3_1', 'Ada_actor_idle3', 125 * 0, 0, 125, 125 );
			this.loadSprite( 'Ada_actor_idle3_2', 'Ada_actor_idle3', 125 * 1, 0, 125, 125 );
			this.loadSprite( 'Ada_actor_idle3_3', 'Ada_actor_idle3', 125 * 2, 0, 125, 125 );
			this.loadSprite( 'Ada_actor_idle3_4', 'Ada_actor_idle3', 125 * 3, 0, 125, 125 );
			this.loadSprite( 'Ada_actor_idle3_5', 'Ada_actor_idle3', 125 * 4, 0, 125, 125 );

			this.loadPicture( 'Ada_moving_chair', 'assets/img/Comic1/Ada_moving_chair.png', on_pic );
			for( let i = 0; i < 23; i++ ){
				this.loadSprite( 'Ada_moving_chair_' + ( i + 1 ), 'Ada_moving_chair', 400 * i, 0, 400, 200 );
			}

			this.loadPicture( 'Ada_moving_chair2', 'assets/img/Comic1/Ada_moving_chair2.png', on_pic );
			for( let i = 0; i < 23; i++ ){
				this.loadSprite( 'Ada_moving_chair2_' + ( 23 - ( i ) ), 'Ada_moving_chair2', 400 * i, 0, 400, 200 );
			}

			this.loadPicture( 'Ada_actor_pull_book', 'assets/img/Comic1/Ada_actor_pull_book.png', on_pic );
			for( let i = 0; i < 10; i++ ){
				this.loadSprite( 'Ada_actor_pull_book_' + ( i + 1 ), 'Ada_actor_pull_book', 194 * i, 0, 194, 300 );
			}

			this.loadPicture( 'Jonathan_actor_idle1', 'assets/img/Comic1/Jonathan_actor_idle1.png', on_pic );
			this.loadSprite( 'Jonathan_actor_idle1_1', 'Jonathan_actor_idle1', 125 * 0, 0, 125, 125 );
			this.loadSprite( 'Jonathan_actor_idle1_2', 'Jonathan_actor_idle1', 125 * 1, 0, 125, 125 );
			this.loadSprite( 'Jonathan_actor_idle1_3', 'Jonathan_actor_idle1', 125 * 2, 0, 125, 125 );
			this.loadSprite( 'Jonathan_actor_idle1_4', 'Jonathan_actor_idle1', 125 * 3, 0, 125, 125 );

			this.loadPicture( 'Ralgo_actor_idle1', 'assets/img/Comic1/Ralgo_actor_idle1.png', on_pic );
			this.loadSprite( 'Ralgo_actor_idle1_1', 'Ralgo_actor_idle1', 125 * 0, 0, 125, 200 );
			this.loadSprite( 'Ralgo_actor_idle1_2', 'Ralgo_actor_idle1', 125 * 1, 0, 125, 200 );

			this.loadPicture( 'Otis_sleeping', 'assets/img/Comic1/Otis_sleeping.png', on_pic );
			this.loadSprite( 'Otis_sleeping1', 'Otis_sleeping', 220 * 0, 0, 220, 100 );
			this.loadSprite( 'Otis_sleeping2', 'Otis_sleeping', 220 * 1, 0, 220, 100 );
			this.loadSprite( 'Otis_sleeping3', 'Otis_sleeping', 220 * 2, 0, 220, 100 );

			this.loadPicture( 'Ada_actor_door', 'assets/img/Comic1/Ada_actor_door.png', on_pic, true );
			this.loadPicture( 'Ada_actor_struggle1', 'assets/img/Comic1/Ada_actor_struggle1.png', on_pic, true );
			this.loadPicture( 'Ada_actor_struggle2', 'assets/img/Comic1/Ada_actor_struggle2.png', on_pic, true );
			this.loadPicture( 'Ada_actor_classroom1_right', 'assets/img/Comic1/Ada_actor_classroom1_right.png', on_pic, true );
			this.loadPicture( 'Ada_actor_classroom1_up', 'assets/img/Comic1/Ada_actor_classroom1_up.png', on_pic, true );
			this.loadPicture( 'Ada_actor_classroom1_left', 'assets/img/Comic1/Ada_actor_classroom1_left.png', on_pic, true );
			this.loadPicture( 'Ada_actor_classroom1_leftup', 'assets/img/Comic1/Ada_actor_leftup.png', on_pic, true );
			this.loadPicture( 'Ada_actor_avcloset', 'assets/img/Comic1/Ada_actor_avcloset.png', on_pic, true );
			this.loadPicture( 'Ada_actor_avcloset2', 'assets/img/Comic1/Ada_actor_avcloset2.png', on_pic, true );
			this.loadPicture( 'Ada_actor_reaching', 'assets/img/Comic1/Ada_actor_reaching.png', on_pic, true );

			this.loadPicture( 'Jonathan_actor_classroom2_idle', 'assets/img/Comic1/Jonathan_actor_talking.png', on_pic, true );
			this.loadPicture( 'Jonathan_actor_lift', 'assets/img/Comic1/John_actor1_lift.png', on_pic, true );
			this.loadPicture( 'Jonathan_actor_right', 'assets/img/Comic1/John_actor1_right.png', on_pic, true );
			this.loadPicture( 'Jonathan_actor_down', 'assets/img/Comic1/John_actor1.png', on_pic, true );
			this.loadPicture( 'Ralgo_actor_classroom2_idle', 'assets/img/Comic1/Ralgo_actor_classroom2_idle.png', on_pic, true );
			...
			this.loadPicture( 'Classroom3_shelf_books', 'assets/img/Comic1/Classroom3_shelf_books.png', on_pic );
			this.loadSprite( 'Classroom3_shelf_books_1', 'Classroom3_shelf_books', 85 * 0, 0, 85, 85 );
			this.loadSprite( 'Classroom3_shelf_books_2', 'Classroom3_shelf_books', 85 * 1, 0, 85, 85 );
			this.loadSprite( 'Classroom3_shelf_books_3', 'Classroom3_shelf_books', 85 * 2, 0, 85, 85 );

			this.loadPicture( 'Girls_talking', 'assets/img/Comic1/Girls_talking.png', on_pic );
			for( let i = 0; i < 8; i++ ){
				this.loadSprite( 'Girls_talking_' + ( i + 1 ), 'Girls_talking', 150 * i, 0, 150, 150 );
			}

			//portraits
			this.loadPicture( 'Ada_angry', 'assets/img/Comic1/Ada_angry.png', on_pic, true );
			this.loadPicture( 'Ada_annoyed', 'assets/img/Comic1/Ada_annoyed.png', on_pic, true );
			this.loadPicture( 'Ada_normal', 'assets/img/Comic1/Ada_normal.png', on_pic, true );
			this.loadPicture( 'Ada_normal2', 'assets/img/Comic1/Ada_normal2.png', on_pic, true );
			this.loadPicture( 'Ada_talking', 'assets/img/Comic1/Ada_normal2.png', on_pic, true );
			this.loadPicture( 'Ada_struggle', 'assets/img/Comic1/Ada_struggle.png', on_pic, true );
			this.loadPicture( 'Ada_surprised', 'assets/img/Comic1/Ada_surprised.png', on_pic, true );
			this.loadPicture( 'Ada_thoughtful', 'assets/img/Comic1/Ada_thoughtful.png', on_pic, true );
			this.loadPicture( 'Ada_worried', 'assets/img/Comic1/Ada_worried.png', on_pic, true );
			this.loadPicture( 'Ada_smug', 'assets/img/Comic1/Ada_smug.png', on_pic, true );
			...
			this.loadPicture( 'Jonathan_worried', 'assets/img/Comic1/Jonathan_worried.png', on_pic, true );
			this.loadPicture( 'Ralgo_actor_lecturing', 'assets/img/Comic1/Ralgo_actor_lecturing.png', on_pic, true );
			this.loadPicture( 'Ralgo_bored', 'assets/img/Comic1/Ralgo_bored.png', on_pic, true );
			this.loadPicture( 'Ralgo_normal', 'assets/img/Comic1/Ralgo_normal.png', on_pic, true );
			this.loadPicture( 'Otis_normal', 'assets/img/Comic1/Otis_normal.png', on_pic, true );
			this.loadPicture( 'Otis_talking', 'assets/img/Comic1/Otis_talking.png', on_pic, true );

			this.loadPicture( 'Banana', 'assets/img/Comic1/banana.png', on_pic, true );
			...
			this.loadPicture( 'Chair2', 'assets/img/Comic1/chair2.png', on_pic, true );
			this.loadPicture( 'AVCloset_door_open', 'assets/img/Comic1/AVCloset_door_open.png', on_pic, true );
			this.loadPicture( 'AVCloset_door_closed', 'assets/img/Comic1/AVCloset_door_closed.png', on_pic, true );
			...
			this.loadPicture( 'Pillow', 'assets/img/Comic1/Pillow.png', on_pic, true );
			this.loadPicture( 'Blue', 'assets/img/Comic1/Blue.png', on_pic, true );

			this.loadPicture( 'Classroom1_bg', 'assets/img/Comic1/Classroom1-bg.png', on_pic, true );
			this.loadPicture( 'Classroom1_fg', 'assets/img/Comic1/Classroom1-fg.png', on_pic, true );
			this.loadPicture( 'Classroom1_fg2', 'assets/img/Comic1/Classroom1-fg2.png', on_pic, true );
			this.loadPicture( 'Classroom2_bg', 'assets/img/Comic1/Classroom2-bg.png', on_pic, true );
			this.loadPicture( 'Classroom2_fg', 'assets/img/Comic1/Classroom2-fg.png', on_pic, true );
			this.loadPicture( 'Classroom3_bg', 'assets/img/Comic1/Classroom3-bg.png', on_pic, true );
			this.loadPicture( 'Classroom3_fg', 'assets/img/Comic1/Classroom3-fg.png', on_pic, true );
			this.loadPicture( 'Classroom4_bg', 'assets/img/Comic1/Classroom4-bg.png', on_pic, true );
			this.loadPicture( 'Classroom4_fg', 'assets/img/Comic1/Classroom4-fg.png', on_pic, true );
			this.loadPicture( 'AVCloset_bg', 'assets/img/Comic1/AVCloset-bg.png', on_pic, true );
			this.loadPicture( 'AVCloset_fg', 'assets/img/Comic1/AVCloset-fg.png', on_pic, true );

			for( let i = 1; i < 9; i++ ) {
				this.loadPicture( 'calc' + i, 'assets/img/Comic1/calc' + i + '.png', on_pic, true );
			}
		} else {
			cb();
		}
	...
	drawLoading() {
		if ( this.ctx ) {
			...
			this.ctx.fillText( 'Loading interactive comic...', 10, 50 );
		}
	}
...
ctx.fillText( 'the experience.', 10, 160 );
ctx.fillStyle = 'white';
ctx.font = '20px monospace';
ctx.fillText( 'Click to begin.', 110, 200 );
